...
//        }
    ...
    public function userReward()
    {
        ...
        foreach ($pigsList as $key => $val) {
            ...
            if ($parents['pid2'] > 0) {
                ...
                //资产记录
                moneyLog($parents['pid2'], $val['uid'], 'share_integral', $secondReward, 4, '二代推广收益');
            }
            ...
            if ($parents['pid3'] > 0) {
                ...
                //资产记录
                moneyLog($parents['pid3'], $val['uid'], 'share_integral', $thirdReward, 4, '三代推广收益');
            }
    ...
    public function urlo(){
        $url= "http://www.lvsjy168.com/api/Plan/resetGames";
        //创建一个新curl资源
        $curl = curl_init();
        // 设置URL和相应的选项
